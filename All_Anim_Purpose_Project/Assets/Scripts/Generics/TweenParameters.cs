...
public class TweenParameters{
    ...
    public TweenParameters(GameObject tweenable, Vector3 targetPosition, Vector3 targetRotationEuler, Vector3 targetScale, float tweenSpeed, float tweenTimeout){
