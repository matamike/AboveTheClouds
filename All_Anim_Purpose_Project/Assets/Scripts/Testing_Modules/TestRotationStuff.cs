...
public class TestRotationStuff : MonoBehaviour{
    ...
    private void Start(){
        RotationConstraintUtility.CalibrateStartingLockLimits(ref minXAxisClampAngle, ref maxXAxisClampAngle, ref minYAxisClampAngle, ref maxYAxisClampAngle, ref minZAxisClampAngle, ref maxZAxisClampAngle, testTarget.transform);
        //CalibrateStartingLockLimits();
    }

    void Update(){
        testTarget.LookAt(lookAtTarget.transform.position, Vector3.up);
        testTarget.transform.eulerAngles = RotationConstraintUtility.GetConstainedRotation(minXAxisClampAngle, maxXAxisClampAngle, minYAxisClampAngle, maxYAxisClampAngle, minZAxisClampAngle, maxZAxisClampAngle, testTarget.transform);
        //LockToTarget();
    }
